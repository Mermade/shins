...
sassRender(path.join(options.root,'custom/stylesheets/screen.css.scss'),path.join(options.root,'pub/css/screen.css'));
sassRender(path.join(options.root,'custom/stylesheets/print.css.scss'),path.join(options.root,'pub/css/print.css'));

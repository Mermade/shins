                            ...
                            },
                            {
                                ...
                                value: function () {
                                    ...
                                    for (
                                        ...
                                        e[f] = arguments[f];
                                    return b(c(this._subscriptions), function (
                                        b
                                    ) {
                                        var c;
                                        return (c = a._subscriptions)[b].apply(
                                            c,
                                            e
                                        );
                                    });
            ...
            function () {
                return (function (h, i, j, k) {
                    ...
                    (function () {
                        ...
                        function c() {
                            for (
                                var a = arguments.length, c = Array(a), d = 0;
                                d < a;
                                d++
                            )
                                c[d] = arguments[d];
                    ...
                    function b() {
                        ...
                        for (var c = 0; c < b.length; c++) {
                            ...
                            if (
                                d &&
                                d.src &&
                                d.src.indexOf(a.CDN_BASE_URL) !== -1
                            )
                                return d;
                        }
                        return null;
            ...
            return (function (g, h, i, j) {
                ...
                (function () {
                    ...
                    var u = "Facebook Pixel Error",
                        v = function () {
                            g.postMessage != null &&
                                g.postMessage.apply(g, arguments);
                        },
                        w = {};
                    function x(a) {
                        switch (a.type) {
                            ...
                            case "UNSUPPORTED_METADATA_ARGUMENT":
                                d = a.metadata;
                                return (
                                    "Unsupported metadata argument: " + d + "."
                                );
            ...
            return (function (h, i, j, k) {
                ...
                (function () {
                    ...
                    function c(c) {
                        if (
                            c == null ||
                            (typeof c === "undefined" ? "undefined" : g(c)) !==
                                "object"
                        )
                            return null;
                        var d = c.eventCount,
        ...
        f.ensureModuleRegistered("SignalsFBEventsFiredEvent", function () {
            return (function (h, i, j, k) {
                ...
                (function () {
                    ...
                    function d(b, d, e) {
                        var f = null;
                        (b === "GET" || b === "POST" || b === "BEACON") &&
                            (f = b);
                        b = d instanceof c ? d : null;
                        d =
                            (typeof e === "undefined" ? "undefined" : g(e)) ===
                            "object"
                                ? a({}, e)
                                : null;
            ...
            function () {
                return (function (h, i, j, k) {
                    ...
                    (function () {
                        ...
                        function i() {
                            for (
                                var a = arguments.length, b = Array(a), f = 0;
                                f < a;
                                f++
                            )
                                b[f] = arguments[f];
            ...
            function () {
                return (function (g, h, i, j) {
                    ...
                    (function () {
                        ...
                        var i = f.getFbeventsModules(
                                "SignalsFBEventsProxyState"
                            ),
                        ...
                        function s() {
                            ...
                            if (
                                a.documentElement &&
                                a.documentElement.getAttribute
                            ) {
                                a = l(
                                    ["selenium", "webdriver", "driver"],
                                    function (a) {
                                        return g.document.documentElement.getAttribute(
                                            a
                                        )
                                            ? !0
                                            : !1;
                        ...
                        function t() {
                            if (u(["_phantom", "__nightmare", "callPhantom"]))
                                return !0;
                            return /HeadlessChrome/.test(g.navigator.userAgent)
                                ? !0
                                : !1;
                        }
                        function u(a) {
                        ...
                        j = new a(function (a, g) {
                            ...
                            e.listen(function (a) {
                                a != null &&
                                    (j[typeof a === "string" ? a : a.id] = !0);
                            });
                            var k = {};
                            d.listen(function (a) {
                                a != null &&
                                    (k[typeof a === "string" ? a : a.id] = !0);
                            });
                            var l = {};
                            c.listen(function (a) {
                                a != null &&
                                    (l[typeof a === "string" ? a : a.id] = !0);
                            });
                            b.listen(function (b) {
                                var c = g.optIns,
                                    d = p(
                                ...
                                c = p(
                                    b != null &&
                                        c.isOptedIn(b.id, "AutomaticSetup"),
                                    h.AUTO_CONFIG
                                );
                                var e = p(
                                        a.disableConfigLoading !== !0,
                                        h.CONFIG_LOADING
                                    ),
                            ...
                            },
                            {
                                ...
                                value: function (a) {
                                    ...
                                    (!this.fbq.pendingConfigs ||
                                        t(this.fbq.pendingConfigs, function (
                                            b
                                        ) {
                                            return b === a;
                                        }) === !1) &&
            ...
            return (function (g, i, j, k) {
                ...
                (function () {
                    ...
                    function m(a) {
                        ...
                        var b = g[k(a)];
                        b =
                            b && b.getProtocol.call && b.getProtocol() === d
                                ? b
                                : null;
                        b !== null &&
                            ((j[a[0]] = j[a[0]] || {}), (j[a[0]][a[1]] = b));
                        return b !== null;
                    }
                    function n(a) {
                        var b = [];
                    ...
                    function r(a) {
                        ...
                        return a.toString && a.toString.call
                            ? a.toString()
                            : void 0;
                    }
                    function s(a) {
            ...
            return (function (g, j, k, l) {
                ...
                (function () {
                    ...
                    function k(a, b) {
                        ...
                        if (
                            b == null ||
                            (typeof b === "undefined" ? "undefined" : h(b)) !==
                                "object"
                        ) {
                ...
                (function () {
                    ...
                    function l(a) {
                        ...
                        a =
                            ...
                            h(a) ||
                            j(a) ||
                            i(a, { ignoreRequestLengthCheck: !0 });
                    ...
                    function V(d) {
                        ...
                        switch (d) {
                            case "endpoint":
                                ...
                                if (typeof i !== "string")
                                    throw new Error(
                                        "endpoint value must be a string"
                                    );
                                b.ENDPOINT = i;
                                break;
                            case "cdn":
